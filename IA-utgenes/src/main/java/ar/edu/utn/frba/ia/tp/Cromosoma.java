...
public class Cromosoma extends Individuo {
	...
	private double aptitudGeneral(ProfesorEspecialidad profesorEspecialidad){
		...
		//El decano imparte su c�tedra junto al aula azul.
		//(Como se sabe que el decano est� en la primer aula, entonces la azul es la segunda).
		...
		//El aula verde est� a la derecha del aula blanca
